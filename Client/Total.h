...
namespace IMAGE
{
	enum ID {
		...
		PICKUP_LIGHT, PICKUP_MEDIUM, PICKUP_HEAVY, PICKUP_SHIELD, PICKUP_HEALTH, PICKUP_GRENADE, PROMPT_E,
		COIN, PLAYER, TELEPORTER, KAMIKAZE_CAGE, GENERATOR, UI_LOBBY_BUTTON, END
	};
}
